 ...
 */
ReflectSensor::~ReflectSensor(void)
{
 ...
 *     <p>No results returned.</p>
 */
ReflectSensor::ReflectSensor(_UINT16 id,AnalogPin pinIn)
	: SimpleSensor(id)
{
	//Set digital.
	digital = _FALSE;
	...
	this->pinIn = pinIn;
#ifdef _DEBUG
	_PRINT0(">ReflectSensor::ReflectSensor : set pins !");
 ...
 *     <p>No results returned.</p>
 */
ReflectSensor::ReflectSensor(_UINT16 id,DigitalPin pinIn)
	: SimpleSensor(id)
{
	//Set digital.
	digital = _TRUE;
 ...
 */
_BOOL ReflectSensor::isLow(void)
{
	//Check flag.
	if(!digital)
	{
 ...
 */
_BOOL ReflectSensor::isHigh(void)
{
	//Check flag.
	if(!digital)
	{
 ...
 *     <p>Anglog value.</p>
 */
int ReflectSensor::getValue(void)
{
	//Check flag.
	if(!digital)
	{
